...
void HAL_FMC_FlashEntry( void )
{
   ...
   SCULV->LVRCR_b.LVREN = 0x00;        // Enable LVR, the Level should be set 2.28V over in LVRCNFIG register of configure option page 1
 ...
 *                   -  Flash Memory:  0x00000000 ~ 0x00007FFF
