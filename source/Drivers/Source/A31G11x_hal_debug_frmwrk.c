/**
 *******************************************************************************
 * @file        A31G11x_hal_debug_frmwrk.c
...
void debug_frmwrk_init( void )
{
   ...
   HAL_GPIO_ConfigOutput( ( Pn_Type* )PB, 5, ALTERN_FUNC );    // PB5   SWDIO    0: SEG20       1: RXD0        2: SWDIO       3: ----        4: ----
   HAL_GPIO_ConfigFunction( ( Pn_Type* )PB, 5, AFSRx_AF1 );

   HAL_GPIO_ConfigOutput( ( Pn_Type* )PB, 4, ALTERN_FUNC );    // PB4   SWCLK    0: SEG21       1: TXD0        2: SWCLK       3: ----        4: ----
   HAL_GPIO_ConfigFunction( ( Pn_Type* )PB, 4, AFSRx_AF1 );

#elif (USED_UART_DEBUG_PORT == 1)

   // Initialize UART1 pin connect
   HAL_GPIO_ConfigOutput( ( Pn_Type* )PB, 7, ALTERN_FUNC );    // PB7            0: SEG18       1: RXD1        2: ----        3: ----        4: ----
   HAL_GPIO_ConfigFunction( ( Pn_Type* )PB, 7, AFSRx_AF1 );

   HAL_GPIO_ConfigOutput( ( Pn_Type* )PB, 6, ALTERN_FUNC );    // PB6            0: SEG19       1: TXD1        2: ----        3: ----        4: ----
