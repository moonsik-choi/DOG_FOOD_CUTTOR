...
void HAL_SCU_MainXtal_PinConfig( uint32_t u32XtalFilter )
{
   ...
   PF->PUPD  &= 0xFFF0;          // PF[1:0]: Pull-up/down resistors Disable
   PF->MOD   &= 0xFFF0uL;
...
void HAL_SCU_SubXtal_PinConfig( void )
{
   ...
   PF->PUPD  &= 0xFF0F;          // PF[3:2]: Pull-up/down resistors Disable
   PF->MOD   &= 0xFF0FuL;
...
void HAL_SCU_CLKO_PinConfig( void )
{
   ...
   PF->PUPD  &= 0xFCFF;       // PF4   CLKO     0: Disable Pull-Up/Down    1: Enable Pull-Up    2: Enable Pull-Down
   PF->MOD   &= 0xFCFFuL;     // PF4   CLKO     0: Input Mode     1: Output Mode    2: Alternative Function Mode
 ...
 *                   Values for TIMER20 ~ TIMER21, TIMER30, TIMER10 ~ TIMER12, PA ~ PF
